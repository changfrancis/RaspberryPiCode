...
#code to run
to = 'changfrancis@hotmail.com' # Email to send to.
gmail_user = 'changfrancis1985@gmail.com' # Email to send from. (MUST BE GMAIL)
gmail_password = '@Creative1' # Gmail password.
...
my_ip_a = 'Hi, Master. Your %s IP is %s' % (ip_type_a, ipaddr_a)
